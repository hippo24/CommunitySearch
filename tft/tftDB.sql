...
CREATE TABLE `USER` (
    `US_KEY` INT PRIMARY KEY NOT NULL,
...
CREATE TABLE `SUMMONER_SEARCHED` (
    `SS_KEY` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `GRANTED_INFO` (
	`GI_KEY` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `BOARD` (
	`BO_KEY` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `POST` (
	`PO_KEY` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `COMMENT` (
	`CO_KEY` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `RECOMMENDED` (
	`REC_KEY` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `POSITION_BOARD` (
	`PB_KEY` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `POSITION` (
	`PS_KEY` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
